...
![Gitter](https://badges.gitter.im/yacy/yacy_search_server.svg)
![Build Status](https://github.com/yacy/yacy_search_server/actions/workflows/ant-build-selfhosted.yaml/badge.svg)
![Install Link](https://img.shields.io/badge/install-stable-blue.svg)
